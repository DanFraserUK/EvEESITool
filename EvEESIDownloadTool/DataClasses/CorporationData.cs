...
namespace EvEESITool
{
	public class CorporationData : DataClassesBase
	{
		...
		protected override void Download()
		{
			...
			Bookmarks = DownloadData("Bookmarks", Settings.EsiClient.Bookmarks.ForCorporation());
			...
			Contracts = DownloadData("Contracts", Settings.EsiClient.Contracts.CorporationContracts(1));
		...
		protected override bool ReadInData()
		{
			...
			{
				CorporationData temp = Settings.MainSettings.serializer.Deserialize<CorporationData>(new JsonTextReader(myReader));
