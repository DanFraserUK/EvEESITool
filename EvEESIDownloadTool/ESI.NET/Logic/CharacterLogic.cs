...
#pragma warning restore CS1998 // Async method lacks 'await' operators and will run synchronously
		{
			throw new NotImplementedException("Do not use this method because the chat servers are broken!");
			//return await Execute<List<ChatChannel>>(_client, _config, RequestSecurity.Authenticated, RequestMethod.GET, "/characters/{character_id}/chat_channels/",
			//	replacements: new Dictionary<string, string>()
			//	{
			//		{ "character_id", character_id.ToString() }
			//	},
		...
		public async Task<EsiResponse<CharacterRoles>> Roles()
			=> await Execute<CharacterRoles>(_client, _config, RequestSecurity.Authenticated, RequestMethod.GET, "/characters/{character_id}/roles/",
				replacements: new Dictionary<string, string>()
				{
					{ "character_id", character_id.ToString() }
				},
