...
namespace EvEESITool
{
    public class SsoLogic
    {
        ...
        /// and this method also uses ESI retrieves other information pertinent to making calls in the EvEESITool API. (alliance_id, corporation_id, faction_id)
